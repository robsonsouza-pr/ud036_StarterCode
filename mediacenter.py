...
ironman = media.Movie(
    "Ironman",
    "The first movie of MCU",
    "https://upload.wikimedia.org/wikipedia/en/7/70/Ironmanposter.JPG",
    "https://www.youtube.com/watch?v=byQpcN78UjQ"
    )
cap = media.Movie(
    "Captain America: The first Avenger",
    "The story of a weak man that became strong",
    "https://upload.wikimedia.org/wikipedia/pt/d/d8/Capit%C3%A3o_Am%C3%A9rica_O_Primeiro_Vingador_-_Poster.jpg",  # noqa
    "https://www.youtube.com/watch?v=vlO0cX8lK88"
    )

spiderman = media.Movie(
    "Spiderman: homecoming",
    "The first movie of Spiderman at MCU",
...
#creating the page with the movie list
